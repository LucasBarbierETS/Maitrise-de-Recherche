multiQWL_cost_function MATLAB Python Package
...
2. Installing the multiQWL_cost_function Package

A. Change to the directory that contains the file setup.py and the subdirectory 
multiQWL_cost_function. If you do not have write permissions, copy all its contents to a 
...
3. Using the multiQWL_cost_function Package

The multiQWL_cost_function package is on your Python path. To import it into a Python 
script or session, execute:

    import multiQWL_cost_function
