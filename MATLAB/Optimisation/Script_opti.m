...
% ===== Options
nombre_points_depart = 2; % nombre de points de depart pour algo multi start
...
optionsGa = optimoptions('ga','MaxGenerations',80,'MaxStallGenerations', 10);
...
save("save_opti/optiresults_"+replace(string(datetime ),':','_')+".mat", 'tableResultats',"seed");
%% =====================  => Affichage

plot(f,alphaMs,"" + ...
    "--",'linewidth',2,"displayname",num2str(2)+"xRH : opti Ms");
