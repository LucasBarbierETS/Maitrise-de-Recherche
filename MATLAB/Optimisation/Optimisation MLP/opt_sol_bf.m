...
new_config = @(params) feval(@(var) sol_bf.create_config(30e-3^2, var.N(1), 30e-3, 30e-3, ...
                                       {var.w1(1), {var.w2(1), var.wend(1), var.N(1)-1, 1}}, ... % largeur des fentes
                                       var.p1(1), ... % porosité de la première plaque
                                       var.r1(1), ..., % rayon des perforations de la 1ère plaque
                                       {2e-3}, ... % épaisseur des plaques
                                       {(58e-3 - 2e-3*var.N(1)) / var.N(1)}, ... % épaisseur des cavités
                                       'Hankel', 'Bezançon', 'true', 'false'), ...
