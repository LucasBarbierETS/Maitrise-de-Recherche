classdef classelement_imported < classelement
    ...
    methods (Static, Access = public)
        ...
        function validate(env)
            ...
            imported_element = classelement_imported(classelement_imported.create_config(env.w/(2*pi), ...
            ...
            plot(env.w/(2*pi), imported_element.alpha(env), 'DisplayName', 'Résultat importé')
            legend()
        end
    end
end