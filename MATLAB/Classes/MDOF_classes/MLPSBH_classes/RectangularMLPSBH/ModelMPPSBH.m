function out = ModelMPPSBH(config, input_model, index, env, varargin)
...
model.param.set(['sol' num2str(index) '_xr'], ['sol' num2str(index) '_xl+sol' num2str(index) '_w'], 'ligne d''acotement horizontal à droite');
model.param.set(['sol' num2str(index + 1) '_xl'], ['sol' num2str(index) '_xl+sol' num2str(index) '_w'], 'ligne d''acotement horizontal à droite');
...
for i = 1:N
    ...
    rp.set('pos', {['sol' num2str(index) '_xc+' num2str(-sw(i)/2)] ['sol' num2str(index) '_yt+' num2str(-sum(pt(1:i)) - sum(ct(1:i-1)))]});
    ...
    rc.set('pos', {['sol' num2str(index) '_xc-sol' num2str(index) '_w/2'] ['sol' num2str(index) '_yt+' num2str(-sum(pt(1:i)) - sum(ct(1:i)))]});
...
for i = 1:N
    ...
    box_MPP.set('ymax', ['sol' num2str(index) '_yt+' num2str(1e-6 - sum(pt(1:i-1)) - sum(ct(1:i-1)))]);
    box_MPP.set('ymin', ['sol' num2str(index) '_yt+' num2str(-1e-6 - sum(pt(1:i)) - sum(ct(1:i-1)))]);
    ...
    box_MPP_bnd.set('ymax', ['sol' num2str(index) '_yt+' num2str(-1e-5 - sum(pt(1:i-1)) - sum(ct(1:i-1)))]);
    box_MPP_bnd.set('ymin', ['sol' num2str(index) '_yt+' num2str(+1e-5 - sum(pt(1:i)) - sum(ct(1:i-1)))]);
...
for i = 1:N
    ...
    box_cav.set('ymax', ['sol' num2str(index) '_yt+' num2str(1e-5- sum(pt(1:i)) - sum(ct(1:i-1)))]);
    box_cav.set('ymin', ['sol' num2str(index) '_yt+' num2str(-1e-5 - sum(pt(1:i)) - sum(ct(1:i)))]);
...
% box_cav_left_bnds.set('ymax', ['sol' num2str(index) '_yt-0.01[mm]']);
...
% box_cav_right_bnds.set('ymax', ['sol' num2str(index) '_yt-0.01[mm]']);
...
box_bnd_ap_tv.set('ymax', ['sol' num2str(index) '_yt-0.01[mm]']);
