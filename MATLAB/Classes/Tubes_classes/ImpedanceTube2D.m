classdef ImpedanceTube2D
    ...
    methods
        ...
        function obj = plot_alpha(obj, env, name)
            ...
            plot(env.w / (2*pi), alpha_model, 'DisplayName', [name ' - Résultat Analytique'])

            % Résultats numériques
            if isfield(obj.Configuration, 'Data2D')
                plot(obj.Configuration.Data2D(:, 1), obj.Configuration.Data2D(:, 2), 'LineStyle', '--', 'DisplayName', [name ' - Résultat FEM'])
            end
