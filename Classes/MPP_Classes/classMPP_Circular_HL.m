    ...
    methods
     ...
     methods (Static, Access = public)
         ...
         function validate()
            ...
            % config = classMPP_Circular_HL.create_config(phi, t, d/2, s);   
            % % config = classMPP_Circular.create_config(phi, t, d/2, s);
            % MPP_HL = classMPP_Circular_HL(config);
            % 
            % 
            % % création de l'environnement
            % env = create_environnement(23, 100800, 22, 1, 5000, 200);
            ...
            % config_HL = classMPP_Circular_HL.create_config(phi, t, d/2, s);
            % MPP_HL = classMPP_Circular_HL(config_HL);
            % 
            % % création de l'élement composé d'une plaque et d'une cavité
            % Cav = classcavity(classcavity.create_config(D, s));
            ...
            %     config_HL = classMPP_Circular_HL.create_config(phi(i), t(i), d(i)/2, s);
            %     list{end+1} = classMPP_Circular(config);
            %     list_HL{end+1} = classMPP_Circular_HL(config_HL);
            ...
            data5_4 = load('C:\Users\lucas.barbier\Documents\Maitrise dossier secondaire\MATLAB\Classes\MPP_Classes\Validation\Thèse_Laly_fig5.4_black.txt');
            ...
            data5_5 = load('C:\Users\lucas.barbier\Documents\Maitrise dossier secondaire\MATLAB\Classes\MPP_Classes\Validation\Thèse_Laly_fig5.5_black.txt');
