classdef classMultiAnnular_Chen < classelement
        ...
        function obj = classMultiAnnular_Chen(config)
            ...
            if nargin > 0    
                ...
                for i = 1:config.CellNumber
                    ...
                    obj.Configuration.ListOfSubelements{end+1} = classcavity_conical(classcavity_conical.create_config(hde, rmp(i), rmp(i+1)));
        
                    % Cavité annnulaire toroidal
                    annular_cavity = classannularcavity_toroidal(classannularcavity_toroidal.create_config(rmp(i), rmp(i+1), rde, hde, 'Volume'));
    ...
    methods (Static, Access = public) % Validation
        ...
        function validate()
            ...
            % fig = perso_ManagedLayout('Validation classMultiAnnular_chen');
            ...
            env = create_environnement(23, 100800, 22, 1, 5000, 5000, 100);
            ...
            data_mod = load('C:\Users\lucas.barbier\Documents\Maitrise dossier secondaire\MATLAB\Classes\MDOF_classes\Validation\validation classMultiAnnular_Chen ChenMTMM2024 fig7a black.txt');
            plot(data_mod(:, 1), data_mod(:, 2), 'DisplayName', 'Données de références - Modèle');

            data_fem = load('C:\Users\lucas.barbier\Documents\Maitrise dossier secondaire\MATLAB\Classes\MDOF_classes\Validation\validation classMultiAnnular_Chen ChenMTMM2024 fig7a red.txt');
            ...
            % Importation des données de références
            data_mod = load('C:\Users\lucas.barbier\Documents\Maitrise dossier secondaire\MATLAB\Classes\MDOF_classes\Validation\validation classMultiAnnular_Chen ChenMTMM2024 fig7b black.txt');
            plot(data_mod(:, 1), data_mod(:, 2), 'DisplayName', 'Données de références - Modèle');

            data_fem = load('C:\Users\lucas.barbier\Documents\Maitrise dossier secondaire\MATLAB\Classes\MDOF_classes\Validation\validation classMultiAnnular_Chen ChenMTMM2024 fig7b red.txt');
            plot(data_fem(:, 1), data_fem(:, 2), 'DisplayName', 'Données de références - FEM');
            ...
            % Importation des données de références
            data_mod = load('C:\Users\lucas.barbier\Documents\Maitrise dossier secondaire\MATLAB\Classes\MDOF_classes\Validation\validation classMultiAnnular_Chen ChenMTMM2024 fig7c black.txt');
            plot(data_mod(:, 1), data_mod(:, 2), 'DisplayName', 'Données de références - Modèle');

            data_fem = load('C:\Users\lucas.barbier\Documents\Maitrise dossier secondaire\MATLAB\Classes\MDOF_classes\Validation\validation classMultiAnnular_Chen ChenMTMM2024 fig7c red.txt');
            plot(data_fem(:, 1), data_fem(:, 2), 'DisplayName', 'Données de références - FEM');
            ...
            % Importation des données de références
            data_mod = load('C:\Users\lucas.barbier\Documents\Maitrise dossier secondaire\MATLAB\Classes\MDOF_classes\Validation\validation classMultiAnnular_Chen ChenMTMM2024 fig7d black.txt');
            plot(data_mod(:, 1), data_mod(:, 2), 'DisplayName', 'Données de références - Modèle');

            data_fem = load('C:\Users\lucas.barbier\Documents\Maitrise dossier secondaire\MATLAB\Classes\MDOF_classes\Validation\validation classMultiAnnular_Chen ChenMTMM2024 fig7d red.txt');
            plot(data_fem(:, 1), data_fem(:, 2), 'DisplayName', 'Données de références - FEM');
