classdef classMPPSBH_Rectangular < classelement
    ...
    methods (Static, Access = public) % Création des configurations
        ...
        function config = create_explicit_rectangular_pattern_config(surface, number_of_plates, cavities_depth, cavities_width, ...
            plates_holes_radius, ...
        ...
        function config = create_explicit_rectangular_pattern_config_without_first_plate(surface, number_of_plates, cavities_depth, cavities_width, ...
            plates_holes_radius, ...
            plates_width_holes_distance, plates_depth_holes_distance, ...
            plates_depth_holes_number, plates_width_holes_number, ...
