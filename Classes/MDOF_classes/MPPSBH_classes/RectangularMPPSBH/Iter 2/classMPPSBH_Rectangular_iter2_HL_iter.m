classdef classMPPSBH_Rectangular_iter2_HL_iter < classMPPSBH_Rectangular

    methods
        function obj = classMPPSBH_Rectangular_iter2_HL_iter(config)
            ...
            if nargin > 0    
                ...
                for i = 1:length(pp)
                    ...
                    % Cavité trapezoidale
                    % obj.Configuration.ListOfObjects{end+1} =
                    % classcavity_rectangular(classcavity_rectangular.create_config(ct(i)/2, mpw(i), mpd(i)));
