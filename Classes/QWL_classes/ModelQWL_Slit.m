function out = ModelQWL_Slit(config, input_model, elem_index, sblm_index, ~)
...
QWL = geom.create(['sol' num2str(elem_index) '_sblm' num2str(sblm_index) '_QWL'], 'Rectangle');
QWL.set('pos', {['sol' num2str(elem_index) '_xl'] ['sol' num2str(elem_index) '_sblm' num2str(sblm_index) '_yt-' num2str(l)]});
QWL.set('size', {num2str(w) num2str(l)});
