folder_path = [env.Root, '\Mesures expérimentales\Echantillons Hutchinson 2ème itération\Incidence normale\Echantillon 2.5'];

% Configuration C2_5

config_2_5_PW = classMPPSBH_Rectangular.create_explicit_slit_pattern_config(28e-3^2, 5, 28e-3, 28e-3, ...
    {5.9531e-04}, ...
...
config_2_5_PWC = classMPPSBH_Rectangular.create_explicit_slit_pattern_config(28e-3^2, 5, 28e-3, 28e-3, ...
    {5.9531e-04}, ...
    {[0.0025 0.0024 0.0025 0.0025 0.0024]}, ...
    {[0.0028 0.0028 0.0028 0.0028 0.0028]}, ...
    {10}, ...
...
config_2_5_LV = classMPPSBH_Rectangular.create_explicit_slit_pattern_config(28e-3^2, 5, 28e-3, 28e-3, ...
    {5.9531e-04}, ...
    {[0.0025 0.0024 0.0025 0.0025 0.0024]}, ...
    {[0.0028 0.0028 0.0028 0.0028 0.0028]}, ...
    {10}, ...
...
MPPSBH_PW = classMPPSBH_Rectangular_iter2(config_2_5_PW);
MPPSBH_PWC = classMPPSBH_Rectangular_iter2(config_2_5_PWC);
MPPSBH_LV = classMPPSBH_Rectangular_iter2(config_2_5_LV);

% perso_figure('Validation expérimentale - C2.5 - 100 dB'); hold on % Affichage individuel
perso_figure('Comparaison expérimental - numérique'); subplot(4, 2, 5); hold on % Affichage groupé
...
Tube2D_tv.plot_alpha('C2.5 num. 2D');
...
Tube3D_ap.plot_alpha('C2.5 num. 3D');
...
%                                            'Incidence normale\Echantillon 2.5\Export_Data_5']);
% 
...
N = 2; % Mesure associée à l'échantillon 2.5
...
% Courbe moyenne
plot(f, m, 'b', 'DisplayName', 'C2.5 exp.', 'LineWidth', 0.5);
