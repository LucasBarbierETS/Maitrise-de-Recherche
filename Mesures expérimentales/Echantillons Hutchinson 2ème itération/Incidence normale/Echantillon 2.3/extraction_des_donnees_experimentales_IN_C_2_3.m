folder_path = [env.Root, '\Mesures expérimentales\Echantillons Hutchinson 2ème itération\Incidence normale\Echantillon 2.3'];

% Configuration C2_3

config_2_3_PW = classMPPSBH_Rectangular.create_explicit_slit_pattern_config(28e-3^2, 5, 28e-3, 28e-3, ...
    {5.9531e-04}, ...
...
config_2_3_PWC = classMPPSBH_Rectangular.create_explicit_slit_pattern_config(28e-3^2, 5, 28e-3, 28e-3, ...
    {5.9531e-04}, ...
    {[0.0025 0.0024 0.0025 0.0025 0.0025]}, ...
    {[0.0028 0.0028 0.0028 0.0028 0.0028]}, ...
    {10}, ...
...
config_2_3_LV = classMPPSBH_Rectangular.create_explicit_slit_pattern_config(28e-3^2, 5, 28e-3, 28e-3, ...
    {5.9531e-04}, ...
    {[0.0025 0.0024 0.0025 0.0025 0.0025]}, ...
    {[0.0028 0.0028 0.0028 0.0028 0.0028]}, ...
    {10}, ...
...
MPPSBH_PW = classMPPSBH_Rectangular_iter2(config_2_3_PW);
MPPSBH_PWC = classMPPSBH_Rectangular_iter2(config_2_3_PWC);
MPPSBH_LV = classMPPSBH_Rectangular_iter2(config_2_3_LV);
...
Tube2D_tv.plot_alpha('C2.3 num. 2D');
...
N = 3; % Mesure associée à l'échantillon 2.3
...
% Courbe moyenne
plot(f, m, 'b', 'DisplayName', 'C2.3 exp.', 'LineWidth', 0.5);
