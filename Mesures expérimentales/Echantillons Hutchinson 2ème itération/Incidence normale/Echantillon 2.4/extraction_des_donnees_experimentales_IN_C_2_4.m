...
config_2_4_PWC = classMPPSBH_Rectangular.create_explicit_slit_pattern_config(28e-3^2, 5, 28e-3, 28e-3, ...
    {5.9531e-04}, ...
    {[0.0024 0.0025 0.0025 0.0024 0.0025]}, ...
    {[0.0028 0.0028 0.0028 0.0028 0.0028]}, ...
    {10}, ...
...
MPPSBH_PWC = classMPPSBH_Rectangular_iter2(config_2_4_PWC);
MPPSBH_LV = classMPPSBH_Rectangular_iter2(config_2_4_LV);

% perso_figure('Validation expérimentale - C2.4 - 100 dB'); hold on % Affichage individuel
perso_figure('Comparaison expérimental - numérique'); subplot(4, 2, 4); hold on % Affichage groupé
...
Tube2D_tv.plot_alpha('C2.4 num. 2D');
...
Tube3D_ap.plot_alpha('C2.4 num. 3D');
...
%                                            'Incidence normale\Echantillon 2.4\Export_Data_4']);
% 
...
N = 4; % Mesure associée à l'échantillon 2.4
...
% Courbe moyenne
plot(f, m, 'b', 'DisplayName', 'C2.4 exp.', 'LineWidth', 0.5);
