classdef Cell_MPPSBHr_HL_iter < classelement
    ...
    methods
        function obj = Cell_MPPSBHr_HL_iter(config)
    ...
    methods (Static)
        ...
        function config = create_config(plate_porosity, plate_holes_radius, plate_thickness, ...
                cavity_thickness, cavity_depth, cavity_width, ...
                cell_inner_width, cell_outer_width, cell_inner_depth, cell_outer_depth)
