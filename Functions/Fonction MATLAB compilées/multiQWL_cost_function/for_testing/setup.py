...
if __name__ == '__main__':
    setup_dict = {
        'name': 'multiQWL_cost_function-R2024b',
        'version': '24.2',
        'description': 'A Python interface to multiQWL_cost_function',
        'author': 'MathWorks',
        'url': 'https://www.mathworks.com/',
        'platforms': ['Linux', 'Windows', 'macOS'],
        'packages': [
            'multiQWL_cost_function'
        ],
        'package_data': {'multiQWL_cost_function': ['*.ctf']}
    }
