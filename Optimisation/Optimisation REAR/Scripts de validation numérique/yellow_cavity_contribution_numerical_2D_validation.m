function model = yellow_cavity_contribution_numerical_2D_validation(ETS_yellow_cavity_contribution, env, varargin)
...
% couche d'air et d'une solution acoustique optimisée individuelle
    ...
    % Pour la cavité
    box_cavity = model.component('component').selection.create('cavity', 'Box');
